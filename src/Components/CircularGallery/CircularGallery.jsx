...
class App {
  ...
  addEventListeners() {
    ...
    this.boundOnClick = (e) => {
      ...
      const realIndex = ((centerIndex % half) + half) % half;
      if (this.onItemClick) this.onItemClick(realIndex);
    };
    this.boundTrackDown = (e) => {
      this._mouseDownX = e.clientX || (e.touches && e.touches[0].clientX) || 0;
      this._mouseMoved = false;
    };
    this.boundTrackMove = (e) => {
      if (Math.abs((e.clientX || 0) - this._mouseDownX) > 5)
        this._mouseMoved = true;
    };
    this.gl.canvas.addEventListener("click", this.boundOnClick);
    this.gl.canvas.addEventListener("mousedown", this.boundTrackDown);
    this.gl.canvas.addEventListener("mousemove", this.boundTrackMove);
  }
  destroy() {
